...
public class ZosUploadMojoTest extends AbstractMojoTestCase {
    ...
    public void testConfiguration() throws Exception {
        ...
        assertEquals("zos",
                ((File) getVariableValueFromObject(mojo, "inputFolder"))
                        .getName());
    ...
    public void testFailedExecution() {
        try {
            ...
            assertEquals(
                    "Job submitted to z/OS failed.  Highest condition code: 12",
                    e.getMessage());
        }
    }
    ...
    public void testAbendedExecution() {
        try {
            ...
            assertEquals(
                    "Job submitted to z/OS failed.  Highest condition code: 806",
                    e.getMessage());
        }
    }
    ...
    public void testJclErrorExecution() {
        try {
            ...
            assertEquals(
                    "Job submitted to z/OS failed.  Highest condition code: 9",
                    e.getMessage());
        }
    }
    ...
    protected File getTestPom() throws IOException {
        ...
        testPomStr = testPomStr.replace(
                "${" + HostSettings.HOST_NAME_TAG + "}",
